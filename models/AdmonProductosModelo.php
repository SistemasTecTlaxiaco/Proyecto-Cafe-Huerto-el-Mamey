...
class AdmonProductosModelo{
  ...
  public function modificaProducto($data){
    ...
    if (!empty($data["id"])) {
     ...
     //$sql.= "'', ";                                  //19. fecha baja
     $sql.= "prov='".$data['prov']."', ";            //20. proveedor
     $sql.= "direccion='".$data['direccion']."', ";    //21. direccion
     $sql.= "tam=".$data['tam'].", ";                  //22. tamaño
     $sql.= "obj='".$data['obj']."', ";        //23. objetivo
     $sql.= "beneficios='".$data['beneficios']."', ";      //24. beneficios
  ...
  public function altaProducto($data){
   ...
   $sql.= "'', ";                             //19. fecha baja
   $sql.= "'".$data['prov']."', ";           //20. proveedor
   $sql.= "'".$data['direccion']."', ";       //21. direccion
   $sql.= $data['tam'].", ";                  //22. tamaño
   $sql.= "'".$data['obj']."', ";         //23. objetivo
   $sql.= "'".$data['beneficios']."', ";        //24. beneficios
