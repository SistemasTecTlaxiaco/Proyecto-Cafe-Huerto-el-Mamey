...
echo '<html lang="en">';
echo '<head>';
echo '<title>&lt;model-viewer&gt; template</title>';
...
echo '<model-viewer bounds="tight" enable-pan src="BolsaAnimacion.glb" ar ar-modes="webxr scene-viewer quick-look" camera-controls environment-image="neutral" poster="poster.webp" shadow-intensity="1.45" exposure="0.84" shadow-softness="0.74" animation-name="EsqueletoAction" autoplay>';
...
echo '<img src="ar_hand_prompt.png">';
echo '</div>';
echo '</model-viewer>';
