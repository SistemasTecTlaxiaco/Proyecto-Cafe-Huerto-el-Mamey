...
print "<form action='".URL."carrito/actualiza' method='POST'>";
...
for ($i=0; $i < count($datos["data"]); $i++) { 
  ...
  print "<td>&nbsp;</td>";
  print "<td class='text-right'><a href='".URL."carrito/borrar/";
...
print "<tr>";
print "<td><a href='".URL."tienda' class='btn btn-info' role='button'>Seguir comprando</a></td>";
print "<td><input type='submit' class='btn btn-info' role='button' value='Recalcular'/></td>";
if($verifica){
  print "<td><a href='".URL."carrito/gracias' class='btn btn-success' role='button'>Pagar</a></td>";
} else {
  print "<td><a href='".URL."carrito/checkout' class='btn btn-success' role='button'>Pagar</a></td>";
}
print "</tr>";
print "</table>";
print "</form>";
