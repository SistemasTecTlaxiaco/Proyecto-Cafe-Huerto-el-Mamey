...
<div class="card p-4 bg-light">
  ...
  <tbody>
    ...
    for($i=0; $i<count($datos['data']); $i++){
      ...
      print "</td>";
      //
      print "<td><a href='".URL."admonProductos/cambio/".$datos["data"][$i]["id"]."' class='btn btn-info'>Modificar</a></td>";
      //
      print "<td><a href='".URL."admonProductos/baja/".$datos["data"][$i]["id"]."' class='btn btn-danger'>Borrar</a></td>";
      print "</tr>";
    }
    ?>
  </tbody>
...
<a href="<?php print URL; ?>admonProductos/alta" class="btn btn-success">
