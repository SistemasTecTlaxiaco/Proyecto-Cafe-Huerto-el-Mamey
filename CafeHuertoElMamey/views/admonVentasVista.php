...
<div class="card p-4 bg-light">
  ...
  <tbody>
    ...
    for($i=0; $i<count($datos['data']); $i++){
      ...
      print "<td><a href='".URL."carrito/detalle/".substr($datos["data"][$i]["fecha"],0,10)."/".$datos["data"][$i]["idUsuario"]."' class='btn btn-info'>Detalle</a></td>";
      print "</tr>";
      $tot+= $total;
...
<a href="<?php print URL; ?>carrito/grafica" class="btn btn-success">
